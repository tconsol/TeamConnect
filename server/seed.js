...
const seedSkills = [
  ...
  { name: 'Node.js', iconKey: 'SiNodedotjs', color: '#6ABB3E', proficiency: 93, order: 5, isActive: true },
  { name: 'Java', iconKey: 'FaJava', color: '#EA580C', proficiency: 87, order: 6, isActive: true },
  { name: 'Python', iconKey: 'SiPython', color: '#FACC15', proficiency: 90, order: 7, isActive: true },
  { name: 'MongoDB', iconKey: 'SiMongodb', color: '#4ADE80', proficiency: 90, order: 8, isActive: true },
  { name: 'PostgreSQL', iconKey: 'SiPostgresql', color: '#60A5FA', proficiency: 88, order: 9, isActive: true },
  { name: 'Docker', iconKey: 'SiDocker', color: '#2496ED', proficiency: 86, order: 10, isActive: true },
];
